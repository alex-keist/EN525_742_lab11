...
proc create_root_design { parentCell } {
  ...
  set full_radio_0 [ create_bd_cell -type ip -vlnv jhu.edu:user:full_radio:1.0 full_radio_0 ]
  ...
  set_property CONFIG.channels {2} $lowlevel_dac_intfc_0
...
\
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins fifo_test_0/S_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M01_AXIS] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins fifo_test_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  [get_bd_pins fifo_test_0/s00_axi_aclk] \
  [get_bd_pins fifo_test_0/s_axis_aclk] \
  ...
  [get_bd_pins fifo_test_0/s00_axi_aresetn] \
  [get_bd_pins fifo_test_0/s_axis_aresetn] \
  [get_bd_pins full_radio_0/s00_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fifo_test_0/S00_AXI/S00_AXI_reg] -force
